 ...
 * @author lenovo
 */
@WebServlet(name = "PreDeleteClienteServlet", urlPatterns = {"/PreDeleteClienteServlet"})
public class PreDeleteClienteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("View/confirmacionCliente.jsp").forward(request, response);
