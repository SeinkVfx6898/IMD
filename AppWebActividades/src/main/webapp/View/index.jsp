...
<html lang="en">
    ...
    <body>
        ...
        <form action="PreIndexServlet" method="GET">
            <input  type="search" class="form-control" id="myInput" value="${filtro}"  placeholder="Busca una actividad..."  maxlength="20" name="filtro" 
                    pattern="[^0-9]*" title="¡Introduce solo letras!">
