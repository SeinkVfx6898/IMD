        ...
        <main>
            ...
            <form action="http://localhost:8080/AppWebActividades/PostRegistroServlet" class="formulario" id="formulario" method="GET">           
                ...
                <div class="formulario__grupo" id="grupo__nombre">
                    ...
                    <p class="formulario__input-error">El usuario tiene que ser de 4 a 16 dígitos y solo puede contener numeros, letras y guion bajo.</p>
                    <span class="formulario__input-error">${NomMsg}</span>
                </div>
                <div class="formulario__grupo" id="grupo__apellido">
                    ...
                    <span class="formulario__input-error">${ApeMsg}</span>
                </div>
                ...
                <div class="formulario__grupo" id="grupo__password2">
                    ...
                    <span class="formulario__input-error">${Pass2Msg}</span>
                </div>
                <div class="formulario__grupo" id="grupo__correo">
                    ...
                    <span class="formulario__input-error">${EmailMsg}</span>
                </div>
                <div class="formulario__grupo" id="grupo__telefono">
                    ...
                    <span class="formulario__input-error">${TlfMsg}</span>
                </div>
